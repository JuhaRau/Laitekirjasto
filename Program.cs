...
namespace Laitekirjasto
{
    ...
    class Device
    {
        ...
        // Luodaan kenttää vastaava ominaisuus (property) Name ja sille asetusmetodi set ja lukumetodi get. Ne voi kirjottaa joko yhdelle tai useammalle riville
        ...
        // Konstruktori eli oliomuodostin (constructor) ilman argumetteja
        public Device()
        {
    ...
    // Pääohjeman luokka, josta tulee Program.exe
    internal class Program
    {
        static void Main(string[] args)
        {
            // Ohjelman varsinaiset toiminnot tapahtuvat täällä
            // Ohjelma kysyy käyttäjältä tietoja laitteesta ja
            // vastaamall kysymyksiin tiedot tallentaan muuttujiin.
